...
def main(script_args, training_args, model_args):
    ...
    if training_args.local_rank in [-1, 0]:
        handlers.append(logging.FileHandler("sft_training.log", mode="w", encoding="utf-8"))
    ...
    # Mirror of the GRPO sft.py pattern. Without this env var, use the
    # full dataset (the prior unconditional 1/160 was a smoke-test
    # leftover that made all RS runs effectively trivial).
